                                        ...
                                        <div class="padding_eight_all bg-white">
                                            ...
                                            <form action="<?php echo e(route('register')); ?>" method="post" id="register_form">
                                                ...
                                                <div class="form-group">
                                                    <input style="border-radius: 27px;" class="form-control" type="text" required="" id="username" name="name" placeholder="<?php echo e(trans('register.full name')); ?>" />
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                                    <span id="phoneError" class="text-danger" style="font-family: 'NotoKufi';"><?php echo e($message); ?></span>
                                                  <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="form-group">
                                                    <input style="border-radius: 27px;" class="form-control" type="text" required="" id="email" name="email" placeholder="<?php echo e(trans('register.email')); ?>" />
                                                    
                                                    <span id="emailError" class="text-danger" class="text-danger" style="font-family: 'NotoKufi';"><?php echo e(Session::get('errors_email')); ?></span>
...
<?php echo $__env->make('layouts.appnotauth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/Lifestyle/resources/views/auth/register.blade.php ENDPATH**/ ?>