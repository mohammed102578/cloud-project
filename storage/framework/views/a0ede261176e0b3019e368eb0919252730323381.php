...
unset($__errorArgs, $__bag); ?>   
     ...
     الغاء
                     ...
                     <table class="table   table-striped ">
                        ...
                        <tbody>
                        <?php if(isset($custodies)): ?>
                        <?php $__currentLoopData = $custodies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $custody): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                  

<!--edit modal-->
<div class="modal fade" id="edit_custody<?php echo e($key); ?>" role="dialog">
    <div class="modal-dialog">
...
unset($__errorArgs, $__bag); ?>   
     ...
     الغاء
                        ...
                        <ul class="dropdown-menu">
                          <li><a class="dropdown-item" href="<?php echo e(route('delete_custody',$key)); ?>"> حذف </a></li>
                          <li><a class="dropdown-item" data-toggle="modal" data-target="#edit_custody<?php echo e($key); ?>"> تعديل</a></li>
                        </ul>
                      </td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/cloud/resources/views/pages/custody.blade.php ENDPATH**/ ?>