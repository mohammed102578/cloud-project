 <div class="col-md-3 sidemenu ">
            <nav id="sidebarMenu" class="shadow col-lg-2 pt-4 d-md-block bg-white sidebar collapse">
               ...
               <div class="position-sticky pt-3">
                  ...
                  <ul class="nav flex-column">
                     <li class="nav-item">
                        <a class="nav-link" href="employess.html">
                  ...
                  <ul class="nav flex-column">
                     ...
                     <li class="nav-item">
                     <a class="nav-link" href="<?php echo e(route('get_document')); ?>">
                        <i class="bi bi-file-zip"></i>
                        المستندات
                        </a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('get_custody')); ?>">
                  ...
                  <ul class="nav flex-column">
                     <li class="nav-item">
                        <a class="nav-link" href="Attendees.html">
...
<?php /**PATH /opt/lampp/htdocs/traffic/resources/views/includes/sidebar.blade.php ENDPATH**/ ?>