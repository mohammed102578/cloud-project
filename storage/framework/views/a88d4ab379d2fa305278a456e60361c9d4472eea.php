...
<?php $s++?>
                                <tr class="pt-30">
                                    ...
                                    <td class="image product-thumbnail pt-40 pr-10"><img style="width: 100px;height:100px;" src="
                                    ...
                                    <td class="product-des product-name">
                                        <h6 class="text-body mb-0 mr-10 ml-10"><?php if($cart->product !==null){
                            ...
                            <table class="table no-border">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                     <form action="<?php echo e(route('localaties')); ?>" method="post">
    <?php echo csrf_field(); ?>
                                        <select name="states_id" class="form-control" onchange="this.form.submit()">
                                            <option>
                                               <?php echo e(trans('cart.select State please')); ?> 
                                               </option>
                                             <?php if(isset($states)): ?>
                                             ...
                                             <option value="<?php echo e($state->id); ?>" 
                                               ...
                                               if(isset($state_id)){
                                                ...
                                                > <?php echo e($state->states_name); ?></option>
                                             <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                             <?php endif; ?>
                                        </select>
                                     </form>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                     <form action="<?php echo e(route('units')); ?>" method="post">
    <?php echo csrf_field(); ?>
                                        <select name="localaty_id" class="form-control" onchange="this.form.submit()">
                                            <option>
                                               <?php echo e(trans('cart.select Local please')); ?> 
                                               </option>
                                             <?php if(isset($localaties)): ?>
                                             ...
                                             <option value="<?php echo e($localaty->id); ?>" 
                                                
                                                    
                                                <?php if(isset($localaty_id)): ?>
                                                <?php
                                                if($localaty_id==$localaty->id){
                                                    echo "selected";
                                                }
                                                ?>
                                                <?php endif; ?>
                                                
                                                > <?php echo e($localaty->localaty_name); ?></option>
                                             <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                             <?php endif; ?>
                                        </select>
                                    ...
                                    <tr>
                                        <td  colspan="2">
                                            <form action="<?php echo e(route('add_order')); ?>" method="post">
                                                <?php echo csrf_field(); ?>
...
<?php endif; ?>
                     ...
                     <option>
                    <?php echo e(trans('cart.select Administrative unit please')); ?>
         ...
         <option value="<?php echo e($unit->unit_name); ?> ,<?php echo e($unit->price); ?>" > <?php echo e($unit->unit_name); ?></option>
         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
         <?php endif; ?>
        </select>
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <input type="hidden" value="<?php echo e($state_id); ?>" name="state_id">
                                            <?php endif; ?>
                                    <input type="text" name="prominent_place" placeholder="<?php echo e(trans('cart.pleas Add prominent_place')); ?>">
                                    ...
                                    <tr>
                                        <td colspan="2" class="cart_total_amount">
                                            <button style="font-family: 'NotoKufi';"type="submit"class="btn mb-0 w-100 " ><?php echo e(trans('cart.Check out')); ?></i></button>
                                            <td class="cart_total_label">
   ...
   <script>
    $(document).ready(function () {
        $('select[name="state_id"]').on('change', function () {
            ...
            if (state_id) {
                $.ajax({
                    url: "<?php echo e(URL::to('state')); ?>/" + state_id,
                    type: "GET",
                    dataType: "json",
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/Lifestyle/resources/views/pages/cartDelivery.blade.php ENDPATH**/ ?>