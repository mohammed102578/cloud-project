...
<head>
    ...
    <link href="<?php echo e(URL::asset('material/css/bootstrap.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(URL::asset('material/css/css/fontawesome-all.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(URL::asset('material/css/css/swiper.css')); ?>" rel="stylesheet">
	<link href="<?php echo e(URL::asset('material/css/magnific-popup.css')); ?>" rel="stylesheet">
	<link href="<?php echo e(URL::asset('material/css/styles.css')); ?>" rel="stylesheet">
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                ...
                <span class="nav-item">
                    <a class="btn-outline-sm" href="<?php echo e(route('user.index')); ?>">LOG IN</a>
                </span>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-xl-5">
                        <div class="text-container">
                            ...
                            <a class="btn-solid-lg page-scroll" href="<?php echo e(route('user.index')); ?>">SIGN UP</a>
    ...
    <svg class="header-frame" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" viewBox="0 0 1920 310"><defs><style>.cls-1{fill:var(--main-color);}</style></defs><title>header-frame</title><path class="cls-1" d="M0,283.054c22.75,12.98,53.1,15.2,70.635,14.808,92.115-2.077,238.3-79.9,354.895-79.938,59.97-.019,106.17,18.059,141.58,34,47.778,21.511,47.778,21.511,90,38.938,28.418,11.731,85.344,26.169,152.992,17.971,68.127-8.255,115.933-34.963,166.492-67.393,37.467-24.032,148.6-112.008,171.753-127.963,27.951-19.26,87.771-81.155,180.71-89.341,72.016-6.343,105.479,12.388,157.434,35.467,69.73,30.976,168.93,92.28,256.514,89.405,100.992-3.315,140.276-41.7,177-64.9V0.24H0V283.054Z"/></svg>
    <!-- end of header -->
    ...
    <!-- Footer -->
    <svg class="footer-frame" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" viewBox="0 0 1920 79"><defs><style>.cls-2{fill:var(--main-color);}</style></defs><title>footer-frame</title><path class="cls-2" d="M0,72.427C143,12.138,255.5,4.577,328.644,7.943c147.721,6.8,183.881,60.242,320.83,53.737,143-6.793,167.826-68.128,293-60.9,109.095,6.3,115.68,54.364,225.251,57.319,113.58,3.064,138.8-47.711,251.189-41.8,104.012,5.474,109.713,50.4,197.369,46.572,89.549-3.91,124.375-52.563,227.622-50.155A338.646,338.646,0,0,1,1920,23.467V79.75H0V72.427Z" transform="translate(0 -0.188)"/></svg>
    <div class="footer">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
    ...
    <div class="copyright">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <p class="p-small">Copyright © 2020 <a href="https://inovatik.com">EtooPlayTim</a><br>
    ...
    <!-- Scripts -->
    <script src="<?php echo e(URL::asset('material/js/jquery.min.js')); ?>"></script> <!-- jQuery for Bootstrap's JavaScript plugins -->
    <script src="<?php echo e(URL::asset('material/js/js/popper.min.js')); ?>"></script> <!-- Popper tooltip library for Bootstrap --> 
    <script src="<?php echo e(URL::asset('material/js/jquery.easing.min.js')); ?>"></script> <!-- jQuery Easing for smooth scrolling between anchors -->
    <script src="<?php echo e(URL::asset('material/js/swiper.min.js')); ?>"></script> <!-- Swiper for image and text sliders -->
    <script src="<?php echo e(URL::asset('material/js/jquery.magnific-popup.js')); ?>"></script> <!-- Magnific Popup for lightboxes -->
    <script src="<?php echo e(URL::asset('material/js/validator.min.js')); ?>"></script> <!-- Validator.js - Bootstrap plugin that validates forms -->
    <script src="<?php echo e(URL::asset('material/js/scripts.js')); ?>"></script> <!-- Custom scripts -->
    <script src="<?php echo e(URL::asset('material/js/js/bootstrap.min.js')); ?>"></script> <!-- Bootstrap framework -->
    <!-- test js-->
    
</body>
</html><?php /**PATH /opt/lampp/htdocs/Lifestyle/resources/views/admin/welcome.blade.php ENDPATH**/ ?>