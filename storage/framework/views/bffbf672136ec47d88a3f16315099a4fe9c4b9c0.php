...
<!--edit modal-->
<div class="modal fade" id="edit_document<?php echo e($document->id); ?>" role="dialog">
    <div class="modal-dialog">
              ...
              <?php echo csrf_field(); ?>
                <div class="pl-lg-10">
                  <div class="row">
                    ...
                    <input type="hidden" name="file" value="<?php echo e($document->type); ?>">
...
unset($__errorArgs, $__bag); ?>   
                    ...
                    <div class="form-group">
                        <label class="form-control-label" for="">نوع المستند </label>
                        <input type="file"  name="type" class="form-control " accept="pdf" placeholder=" نوع المستند" value="" >
                        <?php $__errorArgs = ['type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>   
                    ...
                    <div class="form-group">
                    <label class="form-control-label" for="">الوصف</label>
                    <input type="text"  name="description" class="form-control "  placeholder="الوصف" value="<?php echo e($document->description); ?>">
                    <?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>   
  ...
  <tr data-bs-toggle="offcanvas" href="#offcanvasExample" role="button"
                    aria-controls="offcanvasExample">
                      ...
                      <td data-label="النوع"><a href="<?php echo e($document->description); ?>" target="blank" class="pdf">
                        ...
                        <ul class="dropdown-menu">
                          <li><a class="dropdown-item" href="<?php echo e(route('delete_document',$document->id)); ?>"> حذف </a></li>
                          <li><a class="dropdown-item" data-toggle="modal" data-target="#edit_document<?php echo e($document->id); ?>">  تعديل</a></li>
                        </ul>
                      </td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/traffic/resources/views/pages/document.blade.php ENDPATH**/ ?>