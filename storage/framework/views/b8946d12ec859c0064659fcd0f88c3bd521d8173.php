      ...
      <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-warning">
              <h4 class="card-title "> <?php echo e(__('messages.Sells_by_Product')); ?></h4>
...
<div class="container">
<form Action ="<?php echo e(route('sale_product')); ?>" method="post" > 
<?php echo csrf_field(); ?>
    <div class="row">
                  <div class="col-lg-6">
...
<label class="form-control-label" for="input-username"><?php echo e(__('messages.Select_Product')); ?></label>
                    <select class="form-control form-control-alternative" id="product_id" name="product_id">
                    <?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($result->id); ?>"><?php echo e($result->product_name); ?></option>
            ...
            <table id="example"class="display" style="width:100%">
                <thead  class=" text-block">
                    ...
                    <th>#<?php echo e(__('messages.index')); ?></th>
                        ...
                        <th> <?php echo e(__('messages.product price')); ?></th>
                        <th> <?php echo e(__('messages.product quantity')); ?></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="product name"><?php echo e($value->product->product_name); ?></td>
                        <td class="product price"><?php echo e($value->product-> product_price); ?></td>
                        <td class="product quantity"><?php echo e($value-> quantity); ?></td>
...
<?php echo $__env->make('admin.app.layouts.app', [
    'class' => 'login-page',
    'elementActive' => ''
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/Lifestyle/resources/views/admin/pages/sales_product.blade.php ENDPATH**/ ?>