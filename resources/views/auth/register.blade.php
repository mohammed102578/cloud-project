                                    ...
                                    <div class="login_wrap widget-taber-content background-white">
                                        <div class="padding_eight_all bg-white">
                                            ...
                                            <form action="{{ route('register') }}" method="post" id="register_form">
                                                ...
                                                <div class="form-group">
                                                    <input style="border-radius: 27px;" class="form-control" type="text" required="" id="phone" name="phone" placeholder="{{trans('register.phone')}}" />
                                              
                                                    @error('phone')
                                                    <span id="phoneError" class="text-danger" style="font-family: 'NotoKufi';">{{$message}}</span>
                                                  @enderror
                                                </div>
                                                <div class="form-group">
                                                    <input style="border-radius: 27px;" class="form-control" type="text" required="" id="email" name="email" placeholder="{{trans('register.email')}}" />
